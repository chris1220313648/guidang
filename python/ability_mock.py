...
class Ability:
    ...
    def regist(self):
        ...
        res = requests.post(f"http://127.0.0.1:5200/register", headers=self.headers, json=data)
    ...
    def update_status(self):
        ...
        res = requests.put(f"http://127.0.0.1:5200/update", headers=self.headers, json=data)
