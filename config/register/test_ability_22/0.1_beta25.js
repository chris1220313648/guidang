...
async function main() {
    ...
    console.log("Value of ability 22 from sensor is ", isonline);
    if (isonline == "0") {
        ...
        const full_url = http_url.startsWith("http://") || http_url.startsWith("https://") 
            ? `${http_url}/ability/change_status/alertforability22`
            : `http://${http_url}/ability/change_status/alertforability22`;
