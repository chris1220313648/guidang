...
((window) => {
  ...
  class Console {
    ...
    #printFunc = (level, msg) => core.opSync("op_log", level, msg);
    ...
    log = (...args) => this.#logLevel(2, args);

    debug = (...args) => this.#logLevel(1, args);

    info = (...args) => this.#logLevel(2, args);
    ...
    warn = (...args) => this.#logLevel(3, args);

    error = (...args) => this.#logLevel(4, args);
    ...
    clear = () => {
      this.indentLevel = 0;
      this.#printFunc(1, "Console was cleared");
    };
