...
use proto::{server_message::run_script::{ReadDevice,ReadAbility}, QosPolicy};
...
#[derive(Debug)]
pub struct ReadableAbilities {
    pub abilities: HashMap<String, ReadAbility>,
}
...
pub struct WritableAbilities {
    pub abilities: HashMap<String, AbilitySnapshot>,
}
...
pub struct AbilitySnapshot {//表示设备的快照，包含设备名称和待提交更改的映射。
    pub name: String,
    pub http_url:String,
